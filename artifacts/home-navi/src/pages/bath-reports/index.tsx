...
import { Bath, Plus, ChevronRight, Download, Printer } from "lucide-react";
...
export default function BathReportsList() {
  ...
  const quickActions = [
    { label: "新規作成", icon: Plus, href: "/bath-reports/new", color: "bg-primary" },
    { label: "印刷", icon: Printer },
      ...
      <div className="space-y-4">
        ...
        <div className="lg:grid lg:grid-cols-[1fr_260px] lg:gap-5 lg:items-start space-y-4 lg:space-y-0">
          ...
          <div className="hidden lg:flex flex-col gap-4">
            ...
            <StaffMemoCard memo="入浴後の状態変化がある場合は申し送りにも共有してください。" />
          </div>
        </div>
      </div>
    </Layout>
