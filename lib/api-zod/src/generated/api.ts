 ...
 */
export const listTransferRequestsQuerySortDefault = `due_date`;

export const ListTransferRequestsQueryParams = zod.object({
  status: zod.enum(["未処理", "処理済"]).optional(),
  sort: zod
    .enum(["due_date", "payer_company"])
    .default(listTransferRequestsQuerySortDefault),
});

export const ListTransferRequestsResponseItem = zod.object({
  id: zod.number(),
  title: zod.string(),
  payeeCompany: zod.string(),
  payerCompany: zod.string(),
  dueDate: zod.string(),
  status: zod.enum(["未処理", "処理済"]),
  amount: zod.number().nullish(),
  pdfUrl: zod.string().nullish(),
  requestedByName: zod.string(),
  bankInfo: zod.string().nullish(),
  notes: zod.string().nullish(),
  createdAt: zod.string(),
});
export const ListTransferRequestsResponse = zod.array(
  ListTransferRequestsResponseItem,
);

/**
 * @summary Create a transfer request
 */
export const createTransferRequestBodyStatusDefault = `未処理`;
...
export const CreateTransferRequestBody = zod.object({
  ...
  status: zod
    .enum(["未処理", "処理済"])
    .default(createTransferRequestBodyStatusDefault),
  amount: zod.number().nullish(),
  pdfUrl: zod.string().nullish(),
  requestedByName: zod.string(),
  bankInfo: zod.string().nullish(),
...
export const UpdateTransferRequestBody = zod.object({
  ...
  payeeCompany: zod.string().optional(),
  payerCompany: zod.string().optional(),
 ...
 */
export const DeleteTransferRequestParams = zod.object({
  id: zod.coerce.number(),
});
